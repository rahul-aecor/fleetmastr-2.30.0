        ...
        var gridOptions = {
            ...
            colModel: [
                ...
                },
                {
                    ...
                    formatter: function( cellvalue, options, rowObject ) {
                        var lab;
                        if (cellvalue.toLowerCase() == 'service' || cellvalue.toLowerCase() == 'service (with defects)' || cellvalue.toLowerCase() == 'roadworthy' || cellvalue.toLowerCase() == 'roadworthy (with defects)') {
                            lab = 'label-success';
                        }
        ...
        success: function(response) {
            ...
            if(typeof Site.page != 'undefined' && Site.page == 'edit') {
                if(typeof Site.isSuperAdmin != 'undefined' && Site.isSuperAdmin) {
                    ...
                    $('#status').append('<option value="Archived">Archived</option>');
                    $('#status').append('<option value="Archived - De-commissioned">Archived - De-commissioned</option>');
                    $('#status').append('<option value="Archived - Written off">Archived - Written off</option>');
                    $('#status').append('<option value="Archived - Sold">Archived - Sold</option>');
                }
            }
