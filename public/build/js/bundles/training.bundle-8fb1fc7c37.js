...
module.exports = {
    ...
    methods: {
        ...
        clearAcknowledgement: function clearAcknowledgement() {
            this.hideModal();
        },
        removeAcknowledgement: function removeAcknowledgement() {
...
module.exports = '<div id="acknowledgement-modal" class="modal fade js-acknowledgement-modal" data-width="800" tabindex="-1" data-background="static" aria-labelledby="myModalLabel" aria-hidden="true">\n        <div class="modal-header bg-red-rubine d-flex align-items-center justify-content-between">\n            <h4 class="modal-title">Acknowledgement Message</h4>\n            <a class="font-red-rubine" data-dismiss="modal" aria-label="Close">\n                <i class="jv-icon jv-close"></i>\n            </a>\n        </div>\n    <div class="modal-body" id="ajax-modal-content">\n        <form action="#" :id="id" class="horizontal-form">\n            <p>Ask recipients to confirm receipt of your message*:</p>\n            <div class="row">\n                <div class="col-md-12">\n                    <div class="form-group mb-0">\n                        <textarea :name="name" class="form-control" rows="5" maxlength="200" v-model=\'acknowledgement_message\' data-rule-required="true"></textarea>\n                        <div class="text-right">{{ remainingCharacterCount }}/200 remaining characters</div>\n                        <div class="form-control-focus"></div>\n                    </div>\n                </div>\n            </div>\n        </form>\n    </div>\n    <div class="modal-footer">\n        <div class="btn-group pull-left width100">\n            <button id="closeAcknowledgementDilog" type="button" class="btn white-btn btn-padding col-md-6" @click=\'clearAcknowledgement\'>Cancel</button>\n            <button id="btnSubmitAcknowledgement" type="button" class="btn red-rubine btn-padding col-md-6 submit-button" @click=\'submitAcknowledgement\'>Save</button>\n            <button id="btnRemoveAcknowledgement" type="button" class="btn white-btn btn-padding col-md-12 margin-top-15 submit-button" @click=\'removeAcknowledgement\'>Remove acknowledgement</button>\n        </div>\n    </div>\n</div>';
...
},{"./template.html":19,"lodash":1}],19:[function(require,module,exports){
module.exports = '<div class="checkbox-list">\n    <label>\n        <div class="checker">\n            <span class="{{ siteContact.id }}" v-on:click="siteContactCheckboxClicked(siteContact)">\n                <input type="checkbox" name="siteContactCheckbox">\n            </span>\n        </div> \n        {{ siteContact.first_name }} {{ siteContact.last_name }} \n        (<a class="font-blue" v-bind:href="\'mailto:\' + siteContact.email">{{ siteContact.email == null ?  siteContact.first_name + \'.\' + siteContact.last_name : siteContact.email}}</a>) \n    \n        <span v-if="siteContact.user_region && siteContact.user_region.name != \'\'">(Region: {{ siteContact.user_region.name}})</span>\n        <span v-if="siteContact.is_app_installed==1"> <i class="fa fa-mobile"></i></span>\n    </label>\n</div>';
    ...
    methods: {
        ...
        checkAllSiteContacts: function checkAllSiteContacts() {
            ...
            if (this.allUsersChecked) {
                (function () {
                    var filterValue = _this2.searchContacts.toLowerCase();
                    if (filterValue.length) {
                        var fileterUser = _this2.eligibleSiteContacts.filter(function (user) {
                            return user.first_name && user.first_name.toLowerCase().search(filterValue) >= 0 || user.last_name && user.last_name.toLowerCase().search(filterValue) >= 0 || user.email && user.email.toLowerCase().search(filterValue) >= 0 || user.user_region && user.user_region.name.toLowerCase().search(filterValue) >= 0 || user.user_agent && user.user_agent.toLowerCase().search(filterValue) >= 0 || user.job_title && user.job_title.toLowerCase().search(filterValue) >= 0 || user.postcode && user.postcode.toLowerCase().search(filterValue) >= 0;
                        });
                        _this2.$set('formGroup.users', fileterUser);
                    } else {
                        _this2.$set('formGroup.users', u.cloneDeep(_this2.eligibleSiteContacts));
                    }
...
},{"./components/contactcheckbox":16,"./components/sitecontactcheckbox":18,"./template.html":21,"lodash":1}],21:[function(require,module,exports){
...
},{"../group-form/components/contactcheckbox":16,"../group-form/components/sitecontactcheckbox":18,"../multiple-choice-preview":26,"../open-choice-preview":30,"../standard-message-preview":34,"../template-form/components/groupcheckbox":38,"../template-form/directives/editor":40,"./template.html":23,"lodash":1}],23:[function(require,module,exports){
...
module.exports = {
    ...
    computed: {
        ...
        'eligibleUserDivisions': function eligibleUserDivisions() {
            // if (this.message.template.type !== 'standard') {
        ...
        messageHasRecepients: function messageHasRecepients() {
            return this.message.numbers.length || this.message.template.users.length || this.message.template.groups.length || typeof this.message.template.userdivisions !== 'undefined' && this.message.template.userdivisions.length;
        },
        numofMessageUsers: function numofMessageUsers() {
            return typeof this.message.template.users !== 'undefined' ? this.message.template.users.length : 0;
        },
        ...
        numofMessageUserDivisions: function numofMessageUserDivisions() {
    ...
    methods: {
            ...
            if (selectedTemplate.type == 'standard') {
                ...
                setTimeout(function () {
                    ...
                    if (typeof selectedTemplate.attachment_docs != 'undefined' && selectedTemplate.attachment_docs.length > 0) {
                        ...
                        var uniqueIds = '';
                        selectedTemplate.attachment_docs.forEach(function (attachment, index) {
        ...
        checkAllSiteContacts: function checkAllSiteContacts() {
            ...
            if (this.allUsersChecked) {
                (function () {
                    var filterValue = _this2.filterMessage.toLowerCase();
                    if (filterValue.length) {
                        var fileterUser = _this2.eligibleSiteContacts.filter(function (user) {
                            return user.first_name && user.first_name.toLowerCase().search(filterValue) >= 0 || user.last_name && user.last_name.toLowerCase().search(filterValue) >= 0 || user.email && user.email.toLowerCase().search(filterValue) >= 0 || user.user_region && user.user_region.name.toLowerCase().search(filterValue) >= 0 || user.user_agent && user.user_agent.toLowerCase().search(filterValue) >= 0 || user.job_title && user.job_title.toLowerCase().search(filterValue) >= 0 || user.postcode && user.postcode.toLowerCase().search(filterValue) >= 0;
                        });
                        _this2.$set('message.template.users', fileterUser);
                    } else {
                        _this2.$set('message.template.users', u.cloneDeep(_this2.eligibleSiteContacts));
                    }
        ...
        checkAllGroups: function checkAllGroups() {
            ...
            if (this.allGroupsChecked) {
                (function () {
                    var filterValue = _this3.filterMessage.toLowerCase();
                    if (filterValue.length) {
                        var fileterGroup = _this3.eligibleGroups.filter(function (group) {
                            return group.name && group.name.toLowerCase().search(filterValue) >= 0;
                        });
                        _this3.$set('message.template.groups', fileterGroup);
                    } else {
                        _this3.$set('message.template.groups', u.cloneDeep(_this3.eligibleGroups));
                    }
                })();
            } else {
                this.$set('message.template.groups', []);
        ...
        checkAllUserDivisions: function checkAllUserDivisions() {
        ...
        submitacknowledgement: function submitacknowledgement(acknowledgement_message) {
        ...
        clearacknowledgement: function clearacknowledgement(acknowledgement_message) {
        ...
        removeCssClass: function removeCssClass() {
            var tinymceEditor = $('.tab-pane.active').find('.js-tinymce-editor');
            if (!tinymceEditor.find('.mce-path-item.file-lister').length) {
...
},{"../acknowledgement":12,"../group-form/components/contactcheckbox":16,"../group-form/components/sitecontactcheckbox":18,"../multiple-choice-preview":26,"../open-choice-preview":30,"../standard-message-preview":34,"../template-form/components/divisioncheckbox":36,"../template-form/components/groupcheckbox":38,"../template-form/directives/editor":40,"./template.html":25,"lodash":1}],25:[function(require,module,exports){
...
},{"../template-form/directives/editor":40,"./template.html":29}],29:[function(require,module,exports){
...
module.exports = {
    ...
    computed: {
        ...
        totalRecipientsInDivision: function totalRecipientsInDivision() {
            return this.division.users ? this.division.users.length : 0;
        }
    },
    ready: function ready() {},
    methods: {
        divisionCheckboxClicked: function divisionCheckboxClicked(division) {
            var matches = u.find(this.template.userdivisions, { 'id': this.division.id }, 'id');
            if (typeof matches !== 'undefined') {
...
},{"./template.html":37,"lodash":1}],37:[function(require,module,exports){
module.exports = '<div class="checkbox-list division-name">\n    <label>\n        <div class="checker">\n            <span v-bind:class="checked" v-on:click="divisionCheckboxClicked(division)"><input type="checkbox" name="divisionCheckbox"></span>\n        </div> \n        {{ division.name }} <span>({{ totalRecipientsInDivision }})</span>\n    </label>\n</div>';
...
},{"./template.html":39,"lodash":1}],39:[function(require,module,exports){
                ...
                setup: function setup(editor) {
                    ...
                    if (!$("div#questionUpload").length) {
                        ...
                        flow.on('fileSuccess', function (file, message) {
                            ...
                            if (typeof response.uniqueid != 'undefined') {
                                //$('.mce-js-attachment').length &&
...
module.exports = {
    ...
    computed: {
        ...
        numofTemplateUserDivisions: function numofTemplateUserDivisions() {
    ...
    methods: {
        ...
        templateClicked: function templateClicked(clickedTemplate) {
            ...
            if (clickedTemplate.type == 'standard' || clickedTemplate.type == 'survey') {
                if (clickedTemplate.type == 'standard') {
                    this.$set('plugins', 'link image media, placeholder, media, attachment, acknowledgement');
                } else {
                    this.$set('plugins', 'link image media, placeholder, media, attachment');
                }
                var _this = this;
                setTimeout(function () {
                    _this.addCssClass();
                    ...
                    if (typeof _this.formTemplate.attachment_docs != 'undefined' && _this.formTemplate.attachment_docs.length > 0) {
                        ...
                        var uniqueIds = '';
                        _this.formTemplate.attachment_docs.forEach(function (attachment, index) {
                            var uniqueAttachmentId = attachment.name;
                            uniqueIds += uniqueAttachmentId + ',';
                            var filename = attachment.name + ' (' + attachment.filesize_for_display + ')';
                            tinymceEditor.find('.mce-path-item').append('<span class="mce-fieldset-title js-' + uniqueAttachmentId + '"><span class="js-mce-filename">' + filename + '</span><span class="js-remove-attachment mce-ico mce-i-remove" data-attachment-id="' + uniqueAttachmentId + '"></span></span>');
        ...
        templateTypeChanged: function templateTypeChanged() {
            ...
            if (this.clickedTemplate.type !== this.formTemplate.type) {
                if (this.formTemplate.type == 'standard') {
                    this.addCssClass();
                    this.$set('plugins', 'link image media, placeholder, media, attachment, acknowledgement');
                } else if (this.formTemplate.type == 'survey') {
                    this.addCssClass();
                    this.$set('plugins', 'link image media, placeholder, media, attachment');
                } else {
                    this.removeCssClass();
            ...
            if (this.allUsersChecked) {
                (function () {
                    ...
                    if (filterValue.length) {
                        ...
                        _this2.$set('formTemplate.users', fileterUser);
                    } else {
                        _this2.$set('formTemplate.users', u.cloneDeep(_this2.eligibleSiteContacts));
                    }
        ...
        checkAllGroups: function checkAllGroups() {
            ...
            if (this.allGroupsChecked) {
                (function () {
                    var filterValue = _this3.searchContacts.toLowerCase();
                    if (filterValue.length) {
                        var fileterGroup = _this3.eligibleGroups.filter(function (group) {
                            return group.name && group.name.toLowerCase().search(filterValue) >= 0;
                        });
                        _this3.$set('formTemplate.groups', fileterGroup);
                    } else {
                        _this3.$set('formTemplate.groups', u.cloneDeep(_this3.eligibleGroups));
                    }
                })();
            } else {
                this.$set('formTemplate.groups', []);
        ...
        addCssClass: function addCssClass() {
            var tinymceEditor = $('.tab-pane.active:visible').find('.js-tinymce-editor');
            if (!tinymceEditor.find('.mce-path-item.file-lister').length) {
                tinymceEditor.find('.mce-path-item').addClass('file-lister');
            }
        },
...
},{"../acknowledgement":12,"../group-form/components/contactcheckbox":16,"../group-form/components/sitecontactcheckbox":18,"../multiple-choice-questionnaire":28,"../open-choice-questionnaire":32,"../template-form/directives/editor":40,"./components/divisioncheckbox":36,"./components/groupcheckbox":38,"./template.html":42,"lodash":1}],42:[function(require,module,exports){
...
var messageVueObj = new Vue({
    ...
    methods: {
        ...
        //     });
        // },
        getUserRegions: function getUserRegions() {
...
},{"./components/contact-form":14,"./components/group-form":20,"./components/message-form":22,"./components/messages-form":24,"./components/template-form":41,"./filters/date-formatter":43,"lodash":1,"vue":11,"vue-resource":4}]},{},[44]);
