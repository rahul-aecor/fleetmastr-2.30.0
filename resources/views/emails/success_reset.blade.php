						...
						<table width="80%" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr><td align="center">
								<div style="line-height: 24px;">
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
										Your <b>fleet</b>mastr password has been changed. If you did not request this change, please contact the support team at <script>document.write("support"+"@imastr"+".com");</script>.
									</span></font>
								</div>
							</td></tr>
						</table>
