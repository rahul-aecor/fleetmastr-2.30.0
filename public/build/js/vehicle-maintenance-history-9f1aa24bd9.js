    ...
    colModel: [
        ...
        },
        {
            ...
            formatter: function( cellvalue, options, rowObject ) {
                ...
                if(rowObject.event_status == 'Incomplete') {
                    ...
                    returnString+= '<a title="Delete" href="javascript:void(0);" class="btn btn-xs grey-gallery tras_btn disabled"><i class="jv-icon jv-dustbin icon-big"></i></a>';
                }
                return returnString;                
            }
        }
