...
module.exports = {
    ...
    methods: {
        submitDefectDetails: function submitDefectDetails(event) {
...
module.exports = '<div class="modal fade" tabindex="-1" role="dialog" id="defectConfirmModal" data-backdrop="static" data-keyboard="false">\n    <div class="modal-dialog">\n        <div class="modal-content">\n            <div class="modal-header">\n              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>\n              <h4 class="modal-title">Defects Alert</h4>\n            </div>\n            <div class="modal-body">\n              <div class="alert alert-warning">\n                  You have logged {{ prohibitionalDefects.length }} prohibitional defects.\n              </div>\n              <table class="table table-striped">\n                  <thead>\n                      <tr>\n                          <th>#</th>\n                          <th>Defect</th>\n                          <th>Safety notes</th>\n                      </tr>\n                  </thead>\n                  <tr v-for="defect in prohibitionalDefects">\n                      <td>{{ $index+1 }}</td>\n                      <td>{{ defect.text }}</td>\n                      <td>{{ defect.safety_notes }}</td>\n                  </tr>\n              </table>\n              <p>Check the safety notes and then choose a defect category below:</p>\n              <div class="btn-group" role="group" aria-label="...">\n                  <button type="button" class="btn" \n                    v-bind:class="originalDefect.status === \'UnsafeToOperate\' ? \'btn-danger\' : \'btn-default\'"\n                    v-on:click="originalDefect.status = \'UnsafeToOperate\'">\n                    Vehicle unsafe to operate\n                  </button>\n                  <button type="button" class="btn" \n                    v-bind:class="originalDefect.status === \'SafeToOperate\' ? \'green haze\' : \'btn-default\'"\n                    v-on:click="originalDefect.status = \'SafeToOperate\'">\n                    Vehicle safe to operate\n                  </button>\n                </div>              \n            </div>\n            <div class="modal-footer">\n                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>\n                <button type="button" class="btn btn-primary" v-on:click="submitDefectDetails">Submit</button>\n            </div>\n        </div>\n    </div>\n</div>';
...
module.exports = {
    ...
    methods: {
        fetchVehicleDetails: function fetchVehicleDetails(event) {
            event.preventDefault();
...
module.exports = ' <form action="#" id="form-username" class="form-horizontal form-bordered">\n	<div class="form-group">\n		<label class="col-md-4 control-label">Enter Vehicle Registration</label>\n		<div class="col-md-5">\n			<input type="text" class="form-control" \n				v-model="registration" id="vehicle-registration-input">                            \n		</div>\n	</div>\n	<div class="form-actions">\n		<div class="row">\n			<div class="col-md-offset-4 col-md-8">\n				<button type="button" \n					class="btn green-haze"\n					v-on:click="fetchVehicleDetails"\n					v-bind:class="{ \'disabled\': ! registration.length}">\n					<i class="fa fa-check"></i> Next\n				</button>\n				<button type="reset" class="btn default">Cancel</button>\n			</div>\n		</div>\n	</div>                    \n</form>';
...
module.exports = {
    ...
    ready: function ready() {},
    methods: {
        fetchDefectDetails: function fetchDefectDetails(event) {
            event.preventDefault();
...
module.exports = {
    ...
    ready: function ready() {},
    methods: {
        validateOdometerDetails: function validateOdometerDetails(event) {
            event.preventDefault();
...
module.exports = ' <form action="#" id="form-username" class="form-horizontal form-bordered">\n	<div class="form-group">\n		<label class="col-md-4 control-label">\n			Enter the vehicle odometer reading (in {{ vehicle.odometer_unit }})\n		</label>\n		<div class="col-md-5">\n			<input type="text" class="form-control" \n				v-model="odometer">                            \n		</div>\n	</div>\n	<div class="form-actions">\n		<div class="row">\n			<div class="col-md-offset-4 col-md-8">\n				<button type="button" \n					class="btn green-haze"\n					v-on:click="validateOdometerDetails"\n					v-bind:class="{ \'disabled\': ! odometer.length}">\n					<i class="fa fa-check"></i> Next\n				</button>\n				<button type="reset" class="btn default" v-on:click="resetProcess">Cancel</button>\n			</div>\n		</div>\n	</div>                    \n</form>';
...
module.exports = {
    ...
    methods: {
        handleImageChange: function handleImageChange(defect, event) {
        ...
        defectStatusChanged: function defectStatusChanged(action, defect) {
            // reported as defect
...
},{"./template.html":21,"lodash":1}],21:[function(require,module,exports){
...
new Vue({
    ...
    // vue methods
    events: {
        'step1-confirmed': function step1Confirmed(registration) {
            this.$set('registration', registration);
            this.fetchVehicleDetails();
        },
        'step2-confirmed': function step2Confirmed() {
            this.fetchDefectDetails();
        },
        'step3-confirmed': function step3Confirmed(odometer) {
        ...
        'step4-confirmed': function step4Confirmed(prohibitionalDefectsReported) {
        ...
        'prohibitional-defects-confirmed': function prohibitionalDefectsConfirmed() {
            this.submitDefectDetails();
        },
        'reset-process': function resetProcess() {
            this.resetProcess();
        }
    },
    methods: {
        fetchVehicleDetails: function fetchVehicleDetails() {
        ...
        fetchDefectDetails: function fetchDefectDetails() {
        ...
        submitDefectDetails: function submitDefectDetails() {
            // submit the json
...
},{"./components/defects-confirmation-modal":12,"./components/defects-step1":14,"./components/defects-step2":16,"./components/defects-step3":18,"./components/defects-step4":20,"vue":11,"vue-resource":4}]},{},[22]);

//# sourceMappingURL=defects.bundle.js.map
