...
Based on [combodate](http://vitalets.github.com/combodate) plugin (included). To use it you should manually include [momentjs](http://momentjs.com).
    ...
    <script src="\build/js/moment.min-88dfaa2ee6.js"></script>
...
(function ($) {
    ...
    DateField.defaults = $.extend({}, $.fn.editabletypes.date.defaults, {
        ...
        @property tpl 
        **/         
        tpl:'<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn default" type="button"><i class="jv-icon jv-calendar"></i></button></span></div>',
        /**
        @property inputclass 
        @default 'input-small'
        **/         
...
(function ($) {
    ...
    DateTimeField.defaults = $.extend({}, $.fn.editabletypes.datetime.defaults, {
        ...
        @property tpl 
        **/    
        tpl:'<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn date-set default" type="button"><i class="jv-icon jv-calendar"></i></button></span></div>',
         /**
        @property inputclass 
        @default 'input-medium'
        **/         
