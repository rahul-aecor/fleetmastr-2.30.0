	...
	$('#reportsJqGrid').jqGridHelper({
        ...
        colModel:[
            ...
            },            
            {
	        	...
	        	align: 'left',
	        	formatter: function( cellvalue, options, rowObject ) {
	        		return rowObject.last_generated_date ? moment(rowObject.last_generated_date).format('hh:mm:ss DD MMM YYYY')+ ' (<a title="Details" href="'+ rowObject.filename +'" download" class="underline text-primary js-show-data">Download</a>)' : '';
                }
	        },
            {
                label: 'Actions',
	...
	$('#jqGrid1').jqGridHelper({
        ...
        colModel:[
	        ...
	        },
	        {
                ...
                width: 250,
                formatter: function( cellvalue, options, rowObject ) {
                	return moment(rowObject.date_from).format('DD/MM/YYYY') + ' - ' + moment(rowObject.date_to).format('DD/MM/YYYY');//'01/08/2021 - 31/08/2021'
                }
            },
            {
                label: 'File Type',
