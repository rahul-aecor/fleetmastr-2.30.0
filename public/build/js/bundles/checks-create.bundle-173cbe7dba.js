        ...
        verifyOdometer: function verifyOdometer() {
            ...
            if (formOdometer < parseInt(selectedVehicle.odometer)) {
                ...
                this.$http.post('vehicled/defect', {
                    ...
                    this.$set('selectedVehicleInformation.type', response.data.vehicle.profile_details.type);
                    this.$set('selectedVehicleInformation.manufacturer', response.data.vehicle.profile_details.manufacturer);
                    this.$set('selectedVehicleInformation.model', response.data.vehicle.profile_details.model);
                    this.$set('selectedVehicleInformation.lastChecked', response.data.vehicle.vehicle_details.last_check);
                    this.$set('selectedVehicleInformation.status', response.data.vehicle.vehicle_details.status);
