...
$(document).ready(function(){
        ...
        var disable_journeys_daterange = new DateRangePicker('disable_journeys_daterange',
            {
                timePicker: true,
                opens: 'left',
                ranges: {
            ...
            function (start, end) {
                disable_journeys_daterange.setStartDate(start);
                disable_journeys_daterange.setEndDate(end);
            }
        );
