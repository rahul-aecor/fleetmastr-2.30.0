...
$(document).ready(function() {
    ...
    $(document).on('click', '.js-download-report-btn', function() {
    	...
    	if(slug == 'standard_vehicle_planning_report' || slug == 'standard_weekly_maintanance_report' || slug == 'standard_asset_maintenance_report') {
    		showReportCalenderWithFutureDate(slug);
