...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
	...
	<tr><td align="center" bgcolor="#eceef1">
		...
		<table width="96%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
					<a href="{{env('APP_URL')}}" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
	...
	<tr><td align="center" bgcolor="#ffffff">
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
						...
						<table width="80%" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr><td align="center">
								<div style="line-height: 24px;">
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
										Your <b>fleet</b>mastr account has been created. Please click on the button below to set your password and complete your account registration.
									</span></font>
								</div>
							</td></tr>
						</table>
			...
			<tr><td align="center">
				<div style="line-height:24px;">
					<a href="{{ $link }}" target="_blank" style="padding: 15px 40px; background-color: #{!! setting('primary_colour') !!}; color: #fff; font-family: Arial, Helvetica, sans-serif; font-size: 18px; text-decoration: none;">Set password</a>
				</div>
				<!-- padding --><div style="height: 30px; line-height: 30px; font-size: 10px;">&nbsp;</div>
			</td></tr>
			<tr><td align="center">
