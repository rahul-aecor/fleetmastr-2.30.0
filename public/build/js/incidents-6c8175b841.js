    ...
    $("#addIncidentReportSave").on('click',function(e){
        ...
        forumForm.validate({
            ...
            highlight: function (element) { // hightlight error inputs
                ...
                $(element).closest('.error-class').addClass('has-error'); // set error class to the control group
            },
            unhighlight: function (element) { // revert the change done by hightlight
                console.log('element', element)
                // $(element).parents().find('.help-block-error').remove();
                $(element).parents().removeClass('has-error'); // set error class to the control group
            },
            success: function (label) {
                label.closest('.error-class').removeClass('has-error'); // set success class to the control group
            },
