...
$(".postcodefilter-btn-wrapper>.btn").click(function(){
...
$(".JourneyMapView .closeBtn").click(function(){
    ...
    $(".btnCollapsible").addClass("expanded");
    $(".journey-timeline-wrapper-sidebar").addClass("active");
...
$(document).ready(function(){
    ...
    $(".btnCollapsible").click(function(){
        ...
        $(".journey-timeline-wrapper-sidebar").toggleClass("active");
    });
    setTimeout( function(){
