...
$(document).ready(function() {
    ...
    $(document).on('click', '#js-asset-search-btn', function(event) {
        ...
        if (search_for && startRange && search_for !='preventative_maintenance_inspection' && search_for != 'next_service_inspection_distance') {
            f.rules.push({
        ...
        if (search_for && endRange && search_for !='preventative_maintenance_inspection' && search_for != 'next_service_inspection_distance') {
            f.rules.push({
                field: searchAssetField,
                op: "le",
                data: endRange
...
$("#asset-region, #asset-number").on('change',function(e){
    $('#js-asset-search-btn').trigger('click');
});

$("#asset_search_for_date_range").on('change',function(e){
    if($('#asset_search_for').val() != '' && $("#asset_search_for_date_range") != '') {
        $('#js-asset-search-btn').trigger('click');
    }
});
...
if (typeof Site !== 'undefined' && typeof Site.assetsortname !== 'undefined') {
    ...
    if (Site.assetsortname === 'next_service_inspection') {
        searchAssetField = "Service";
    }
