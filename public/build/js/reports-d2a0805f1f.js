...
$('#assetReportBookingDuration').change(function (){
    ...
    setTimeout(function(){
        ...
        if (reportType == 'lastWeek') {
            reportUrl = "/reports/asset_booking_report/lastWeek";
        }
        if (reportType == 'lastMonth') {
            reportUrl = "/reports/asset_booking_report/lastMonth";
        }
        if (reportType == 'last12Months') {
            reportUrl = "/reports/asset_booking_report/last12Months";
        }
        $('#asset_booking_report_btn').attr('href',reportUrl);
    },0010);
