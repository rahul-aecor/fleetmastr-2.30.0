...
<title>{{ strtoupper(env('BRAND_NAME')) }} | Vehicle Import UNSUCCESSFUL</title>
<style type="text/css">
						...
						<table width="80%" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr><td align="center">
								<div style="line-height: 24px;">
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
										The following report/s were unsuccessful:
										<br/>
										fleetmastr - vehicles import
									</span></font>
								</div>
							</td></tr>
						</table>
