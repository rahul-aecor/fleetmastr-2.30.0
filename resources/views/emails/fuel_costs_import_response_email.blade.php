...
<title>{{ strtoupper(env('BRAND_NAME')) }} | Fuel Import Status</title>
<style type="text/css">
						...
						<table width="80%" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr><td align="center">
								<div style="line-height: 24px;">
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
										1. All fuel transactions with a status update and associated comment.<br/>
										2. A list of all fuel transactions not imported. This file will only be attached if there are one or more transactions in this latest data synchronisation that were not imported.<br/>
									</span></font>
								</div>
							</td></tr>
						</table>
