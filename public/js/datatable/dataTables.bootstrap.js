...
$.extend(true, $.fn.dataTable.defaults, {
    ...
    //"dom": "<'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-3 col-sm-12'i><'col-md-2 col-sm-12'l><'col-md-7 col-sm-12'p>>", 

    "dom": "<'table-scrollable't><'row'<'col-md-3 col-sm-12'i><'col-md-2 col-sm-12'l><'col-md-7 col-sm-12'p>>", 


    // default layout with horizobtal scrollable datatable
    //"dom": "<'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r>t<'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>", 

    // datatable layout without  horizobtal scroll(used when bootstrap dropdowns used in the datatable cells)
    "language": {
