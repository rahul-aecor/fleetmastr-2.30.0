...
//Asset Permission
$(document).on('click', '#portlet-user #all_accessible_asset_region', function() {
    if($(this).is(':checked')) {
        $('.all_asset_divisions :checkbox').attr('checked', true).attr('disabled', true).uniform('refresh');
        $('.all_asset_division_region').attr('checked', true).uniform('refresh');
        $('.all_asset_regions :checkbox').attr('disabled', true).attr('checked', true).uniform('refresh');
    } else {
        $('.all_asset_divisions :checkbox').attr('checked', false).attr('disabled', false).uniform('refresh');
        $('.all_asset_division_region').attr('checked', false).uniform('refresh');
        $('.all_asset_regions :checkbox').attr('disabled', false).attr('checked', false).uniform('refresh');
    }
});
