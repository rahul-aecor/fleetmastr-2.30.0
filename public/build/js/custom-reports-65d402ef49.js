liveReportSlugArray = ['standard_last_login_report', 'standard_user_details_report', 'standard_vehicle_profile_report', 'standard_asset_details_report'];
$(document).ready(function() {
	if(typeof Site.reportSlug != 'undefined') {
		if(Site.reportSlug == 'standard_vehicle_planning_report' || Site.reportSlug == 'standard_weekly_maintanance_report' || Site.reportSlug == 'standard_asset_maintenance_report') {
			showReportCalenderWithFutureDate(reportSlug);
