<form class="form-horizontal" role="form" action="/settings/store" method="POST" novalidate>
    <div class="row">
      <div class="col-span-2">
            {{ csrf_field() }}
            <div class="form-body">
                <div class="form-group">
                    <label class="col-md-10 control-label" style="text-align:left;">To preview a new primary colour for the site, select a new colour from the pallette below and click on the 'Ok' button. To use this new colour as the primary colour click on the 'Save' button.</label>
                </div>
                <div class="form-group d-flex">
                    <label for="url" class="col-md-4 control-label align-self-center pt-0"><span class="bold">fleet</span>mastr URL*:</label>
                    <div class="col-md-8">
                ...
                <div class="form-group d-flex">
                    <label for="colorSelector2" class="col-md-4 control-label align-self-center pt-0">Primary colour*:</label>
                    <div class="col-md-8">
                ...
                <div class="form-group d-flex">
                    <label class="col-md-4 control-label align-self-center pt-0">Defect email notifications:</label>
                    <div class="col-md-8">
                        <label class="checkbox-inline pt-0">
                          <input type="checkbox" id="defectNotification" data-toggle="toggle" data-on="Yes" data-off="No"
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-4">
                        <div class="form-text text-muted">Individual user email notification settings are managed in the <a href="{{ url('users') }}"><u>User Management</u></a> area</div>            
                    </div>
                </div>
            </div>
      </div>
      <div class="modal-footer">
        <div class="btn-group pull-left width100">
            ...
            <button type="submit" class="btn red-rubine btn-padding col-md-6" name="submit">Save</button>            
        </div>
      </div>
    </div><!-- /.modal-content -->
</form>
