<div id="markerDetailsModal" class="markerDetailsModal" tabindex="-1" data-background="static">
    <h4><img src="{{$incidentData['icon']}}"> &nbsp; {{$incidentData['incident_name']}}</h4>
        ...
        <tr>
            <td>
                <table class="table table-striped table-hover margin-bottom0">
                    ...
                    <tr>
                        <td>Date/Time:</td>
                        <td>{{ Carbon\Carbon::parse($incidentData['date_edited'])->format('H:i:s d M Y') }}</td>
                    </tr>
            ...
            <td>
                <table class="table margin-bottom0" id="incidentMarkerDetailsRightCol">
                    <tbody>
                    <tr>
                        <td class="text-center">
                            ...
                            <button name="streetViewBtn" class="streetViewBtn">
                                ...
                                {{-- <img src="{{ checkStreetViewAvailability($incidentData['latitude'], $incidentData['longitude'], '400x400') }}" /> --}}
                            </button>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-center">
                            <button class="btn red-rubine showJourneyMapViewFromMarker" data-incident-journey-id="{{$incidentData['journey_id']}}" onclick="showJourneyMapViewFromMarkerClick(this,event)">View journey</button>
                        </td>
                    </tr>
                    </tbody>
                </table>
