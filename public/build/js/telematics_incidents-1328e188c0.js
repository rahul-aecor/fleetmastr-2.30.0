...
var gridOptions ={
    ...
    colModel: [
        ...
        { label: 'Location', name: 'location', title: false, width: 400 },
        { 
...
$(document).ready(function() {
    ...
    $('#anomalyStatus').select2({
        allowClear: true,
        data: Site.anomalyStatus,
        /* minimumInputLength: 1,
        minimumResultsForSearch: -1 */
    });
...
$(".js-reset-filter-value").click(function() {
    ...
    if($("#regionFilterIncident").val() == '' && $("#incidentTypeFilter").val() == '' && $("#registrationIncident").val() == '' && $("#lastnameIncident").val() == '' && $("#anomalyStatus").val() == '') {
        clearIncidentFilter();
...
function getFilterData() {
    ...
    var anomalyStatusFilterValue = $("#anomalyStatus").val();
    ...
    data = {
        ...
        anomalyStatusFilterValue:anomalyStatusFilterValue,
    ...
    onClickButton : function() {
        ...
        f.attr('action', options.url)
         .append(
            ...
            '<input name="endDate">'+
            '<input name="isExportRequest" value="yes">'
        );
