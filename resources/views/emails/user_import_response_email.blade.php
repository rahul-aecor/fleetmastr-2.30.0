...
<title>{{ strtoupper(env('BRAND_NAME')) }} | Driver Import Status</title>
<style type="text/css">
						...
						<table width="80%" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr><td align="center">
								<div style="line-height: 24px;">
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
										1. All users where job title equals "Driver" with a status update and associated comment.<br/>
										2. A list of all new drivers added to <b>fleet</b>mastr. This file will only be attached if any new drivers were added in this latest data synchronisation.<br/>
									</span></font>
								</div>
							</td></tr>
						</table>
