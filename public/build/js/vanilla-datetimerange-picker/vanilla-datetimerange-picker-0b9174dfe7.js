...
(function () {
    ...
    DateRangePicker.prototype = {
        ...
        setEndDate: function(endDate) {
            ...
            if (this.timePicker && this.timePickerIncrement) {
                var calStartDate = moment(this.endDate);
                var calEndDate = moment();
                if(calEndDate.diff(calStartDate, 'days') > 0 && !timeIsUpdated) {
                    $('.right .hourselect option').removeAttr('selected');
                    $(".right .hourselect option[value=23]").prop("selected", "selected")
                    $('.right .minuteselect option').removeAttr('selected');
                    $(".right .minuteselect option[value=59]").prop("selected", "selected")
        ...
        move: function() {
            ...
            } else if (this.opens == 'rightfar') {
                var containerRight = parentRightEdge - elementOffset.left - this.element.offsetWidth;
                    this.container.style.top = containerTop + 'px';
                    this.container.style.right = 'auto';
                    this.container.style.left = '448px';
