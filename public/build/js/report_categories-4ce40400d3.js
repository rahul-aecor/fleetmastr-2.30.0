$(document).ready(function() {
    ...
    function viewAllCategories(redirect, view_id) {
        $("#" + view_id).empty();
        $.ajax({
            url: '/customreports/view_all_report_categories',
            type: 'post',
            dataType: "html",
            data: {
                redirect: redirect
    ...
    $(document).on('click', ".js-category-delete-btn", function() {
        ...
        bootbox.confirm({
            ...
            callback: function(result) {
                if (result) {
                    $.ajax({
                        url: '/customreports/delete_category',
                        type: 'POST',
                        data: {
                            id: id,
                            redirect: redirect
    ...
    function updateCategoryName(redirect) {
        $('.edit_category_name').editable({
            ...
            url: '/customreports/update_category_name',
            emptytext: 'N/A',
            name: redirect,
            placeholder: 'Select',
    ...
    $(document).on("change","#category_id",function() {
        $.ajax({
            url: '/customreports/get_category_dataset',
            dataType: 'html',
            type: 'post',
            data: {
...
function handleUniform() {
    ...
    $(".panel-collapse .panel-body").slimScroll({height: '300px'})
}
