    ...
    <div class="row">
        <div class="col-md-12">
            <form class="row gutters-tiny" id="vehicles-planning-filter-form">
                ...
                <div class="col-lg-4">
                    <div class="row gutters-tiny">
                        <div class="col-lg-7 col-md-12 col-sm-12 select-time-period-group" style="display: none;">
                            <div class="form-group">
                        ...
                        <div class="col-lg-7 col-md-12 col-sm-12 search_for_distance_range" style="display: none;">
                            <div class="form-group">
                        ...
                        <div class="col-lg-5 col-md-12 col-sm-12 vehicle_search">
            ...
            <div class="portlet box">
                <div class="portlet-title bg-red-rubine">
                    ...
                    <div class="actions new_btn align-self-end">
                        ...
                        @if(Auth::user()->isUserInformationOnly())
                             <!-- <a href="{{ url('/vehicles/create') }}" disabled="disabled" class="config btn btn-sm gray_btn_border table-group-action-submit title_right_btn"><i class="jv-icon jv-plus "></i> Add vehicle</a> -->
                        @else
                ...
                <div class="portlet-body">
                    <div class="jqgrid-wrapper">
                        <table id="jqGrid" class="table-striped table-bordered table-hover"></table>
