...
var telematics = new Vue({
    ...
    methods: {
        ...
        resetVehicleCounts: function resetVehicleCounts(fromFunction) {
            var _this = this;
        ...
        startMarker: function startMarker(vehicleId) {
            ...
            var iconType = icon.split("_")[0] + '_' + icon.split("_")[1] + '_moving.png';
            marker.setIcon(iconType);
            this.resetVehicleCounts("startMarker");
        ...
        stopMarker: function stopMarker(vehicleId) {
            ...
            marker.setIcon(iconType);
            this.resetVehicleCounts("stopMarker");
            // this.getTelematicsData();
        },
        idlingMarker: function idlingMarker(vehicleId) {
            ...
            marker.setIcon(iconType);
            this.resetVehicleCounts("idleMarker");
            // this.getTelematicsData();
        },
        ...
        plotSearchedVehicleMap: function plotSearchedVehicleMap() {
            ...
            if (filterType != "" || value_search != "" || userName != "" || region != "") {
                ...
                vm.plotVehiclesByVehicleIdList(regsToKeep);
            }
        },
                ...
                if (locationMarkers.length > 0) {
                    for (i = 0; i < locationMarkers.length; i++) {
                        ...
                        if (localStorage.clickedLocationPosition) {
                            ...
                            if (parsedClickedLocationPosition.latitude == locationMarkers[i][1] && parsedClickedLocationPosition.longitude == locationMarkers[i][2]) {
