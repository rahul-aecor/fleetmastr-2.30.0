...
},{"base64-js":2,"ieee754":10,"isarray":12}],5:[function(require,module,exports){
/**
 * Slice reference.
 */
...
},{"buffer":4,"isarray":8}],8:[function(require,module,exports){
...
},{"./manager":17,"./socket":19,"./url":20,"debug":26,"socket.io-parser":45}],17:[function(require,module,exports){
...
},{"./on":18,"./socket":19,"backo2":1,"component-bind":5,"component-emitter":25,"debug":26,"engine.io-client":29,"indexof":11,"socket.io-parser":45}],18:[function(require,module,exports){
...
},{"./on":18,"component-bind":5,"component-emitter":25,"debug":26,"has-binary2":7,"parseqs":42,"socket.io-parser":45,"to-array":47}],20:[function(require,module,exports){
...
},{"debug":26,"parseuri":43}],21:[function(require,module,exports){
...
},{"./debug":27,"_process":15}],27:[function(require,module,exports){
...
},{"ms":14}],28:[function(require,module,exports){
module.exports = (function () {
...
},{"./transport":31,"./transports/index":32,"component-emitter":25,"debug":26,"engine.io-parser":38,"indexof":11,"parseqs":42,"parseuri":43}],31:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../globalThis":28,"./polling":35,"component-inherit":6}],34:[function(require,module,exports){
/* global attachEvent */
...
},{"../globalThis":28,"./polling":35,"component-emitter":25,"component-inherit":6,"debug":26,"xmlhttprequest-ssl":37}],35:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":31,"component-inherit":6,"debug":26,"engine.io-parser":38,"parseqs":42,"xmlhttprequest-ssl":37,"yeast":57}],36:[function(require,module,exports){
(function (Buffer){
/**
 * Module dependencies.
 */
...
},{"../transport":31,"buffer":4,"component-inherit":6,"debug":26,"engine.io-parser":38,"parseqs":42,"ws":3,"yeast":57}],37:[function(require,module,exports){
...
},{"./globalThis":28,"has-cors":9}],38:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"./keys":39,"./utf8":40,"after":21,"arraybuffer.slice":22,"base64-arraybuffer":23,"blob":24,"has-binary2":7}],39:[function(require,module,exports){
...
},{"./is-buffer":46,"isarray":41}],45:[function(require,module,exports){
...
},{"./binary":44,"./is-buffer":46,"component-emitter":25,"debug":26,"isarray":41}],46:[function(require,module,exports){
(function (Buffer){
...
},{"./lib/jsonp":50,"./lib/promise":51,"./lib/xhr":53}],49:[function(require,module,exports){
/**
 * Install plugin.
 */
...
},{"./http":48,"./lib/util":52,"./resource":54,"./url":55}],50:[function(require,module,exports){
/**
 * JSONP request.
 */
...
},{"./promise":51}],51:[function(require,module,exports){
/**
...
},{"./promise":51}],54:[function(require,module,exports){
/**
...
},{"_process":15}],57:[function(require,module,exports){
'use strict';
...
var telematics = new Vue({
    ...
    methods: {
        hideShowMainHeaderOnLiveTab: function hideShowMainHeaderOnLiveTab(hsValue) {
            this.isLiveTabLeftSideHeaderShow = hsValue;
        },
        getRelatedDataOnSearchCriteria: function getRelatedDataOnSearchCriteria() {
        ...
        getSearchCriteriaBaseSelectBox: function getSearchCriteriaBaseSelectBox(v) {
            if (v == 'vehicles') {
                $("#searchBoxLiveMap").select2({
                    allowClear: true,
        ...
        getResultRelatedDataOnSearchVehicle: function getResultRelatedDataOnSearchVehicle(vRegistration) {
        ...
        getVehicleDetail: function getVehicleDetail(vId) {
            var _this = this;
                ...
                success: function success(response) {
                    if (response.status == 1) {
                        ...
                        if ($("#liveTabVehicleListFrontTab").length == 1) {
                            ...
                            $("#divLiveTimeLineSidebar").append(response.data.viewHtml);
                            _this.getLiveTabPageVehicleDetailChart(vId);
                            $("#processingModal").modal('hide');
                        }
                    } else {
                        $("#processingModal").modal('hide');
        ...
        getBackToVehicleList: function getBackToVehicleList() {
            var _this = this;
        ...
        getResultRelatedDataOnSearchUser: function getResultRelatedDataOnSearchUser(uId) {
            //let  selectSearchCriteria=$("#selectSearchCriteria").val();
            $("#processingModal").modal('show');
            $("#liveTabVehicleListFrontTab").remove();
            $("#liveTabUserListFrontTab").remove();
        ...
        getUserVehicleDetail: function getUserVehicleDetail(vId) {
            var _this = this;
            liveTabLastDetailOfVehicleId = vId;
            $("#processingModal").modal('show');
            $.ajax({
        ...
        getBackToUserList: function getBackToUserList() {
            var _this = this;
            _this.hideShowMainHeaderOnLiveTab(true);
            _this.hideAllVehicleMarkers();
            _this.hideAllStoredMarkersTag();
        ...
        getResultRelatedDataOnSearchLocationCategory: function getResultRelatedDataOnSearchLocationCategory(locationCategoryId) {
            var _this = this;
            //let  selectSearchCriteria=$("#selectSearchCriteria").val();
            $("#processingModal").modal('show');
            $("#liveTabVehicleListFrontTab").remove();
        ...
        getCategoryLocationList: function getCategoryLocationList(locationCategoryId) {
            var _this = this;
            $("#processingModal").modal('show');
            $.ajax({
                ...
                success: function success(response) {
                    if (response.status == 1) {
                        ...
                        if ($("#liveTabLocationCategoryListFrontTab").length == 1) {
                            ...
                            $("#divLiveTimeLineSidebar").append(response.data.viewHtml);
                            _this.showLocationsOnLatLong(response.data.data);
                            $("#processingModal").modal('hide');
                        }
                    } else {
                        $("#processingModal").modal('hide');
        ...
        removeLocationMapMarkers: function removeLocationMapMarkers() {
        ...
        setLocationMapMarkers: function setLocationMapMarkers() {
            if (locationMapMarkers.length > 0) {
                for (var i = 0; i < locationMapMarkers.length; i++) {
        ...
        showLocationsOnLatLong: function showLocationsOnLatLong() {
            var newObj = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];

            var _this = this;
            /* console.log('newObj', JSON.stringify(newObj, null, 2));
            return false; */
            _this.removeLocationMapMarkers();
        ...
        getBackToCategoryLocationList: function getBackToCategoryLocationList() {
            var _this = this;
            _this.hideShowMainHeaderOnLiveTab(true);
            _this.hideAllStoredMarkersTag();
        ...
        getLocationInDetail: function getLocationInDetail(locationId) {
            var _this = this;
            $.ajax({
        ...
        getBackToLocationList: function getBackToLocationList() {
            var _this = this;
            _this.hideShowMainHeaderOnLiveTab(false);
            _this.hideAllStoredMarkersTag();
        ...
        getLiveTabFilterView: function getLiveTabFilterView() {
            $("#divLiveTimeLineSidebar").css('display', 'none');
            $(".divLiveTabFilterFrontTab").css('display', 'flex');
        },
        closeLiveTabFilterView: function closeLiveTabFilterView() {
            var _this = this;
            $("#divLiveTimeLineSidebar").css('display', 'block');
            ...
            filteredTagList = [];
            _this.hideAllStoredMarkersTag();
            this.removeLocationMapMarkers();
            this.plotAllVehiclesOnTheMap();
        },
        calculateSearchHeight: function calculateSearchHeight() {
            setTimeout(function () {
        ...
        createAndGetMap: function createAndGetMap() {
            if (map == null) {
        ...
        getSearchedTelematicsData: function getSearchedTelematicsData(_sRegList) {
            $("#processingModal").modal('show');
            var _this = this;
            $.ajax({
        ...
        resetVehicleCounts: function resetVehicleCounts(vehicleId) {
            var _this = this;

            /* console.log(currNsMap[vehicleId]);
            console.log("prevNsMap",prevNsMap[vehicleId]); */
        ...
        plotAllVehiclesOnTheMap: function plotAllVehiclesOnTheMap() {
            var _this = this;
            this.$http.get('/telematics/getAllVehiclesOnFleet').success(function (response) {
                ...
                if (_infoMapLocationId == null) {
                    //it will be called when it's not come from location tab.
                    this.setMapBounds();
                } else {
                    _infoMapLocationId = null;
                }
        ...
        showHideMarkerByReg: function showHideMarkerByReg(registration) {
            var marker = markerMap[registration];
            marker.setVisibility(true);
        },
        hideMarkerByReg: function hideMarkerByReg(registration) {
            var marker = markerMap[registration];
        ...
        plotByPostcode: function plotByPostcode() {
            var thisObj = this;
            ...
            if (reg.test(zipCode)) {
                ...
                geocoder.geocode({
                    ...
                    if (status == google.maps.GeocoderStatus.OK) {
                        ...
                        var postCodeLocationMarker = new google.maps.Marker({
                            position: position,
        ...
        plotSearchedVehicleMap: function plotSearchedVehicleMap(obj) {
            var vm = this;
        ...
        hideAllVehicleMarkers: function hideAllVehicleMarkers() {
            u.forEach(this.vehicles_on_fleet, function (value) {
                var marker = markerMap[value['registration']];
                marker.setVisible(false);
            });
        },
        showAllVehicleMarkers: function showAllVehicleMarkers() {
            u.forEach(this.vehicles_on_fleet, function (value) {
                var marker = markerMap[value['registration']];
                marker.setVisible(true);
            });
        },
        showAllStoredMarkersTag: function showAllStoredMarkersTag() {

            u.forEach(this.vehicles_on_fleet, function (value) {
                var contentString = value['registration'];
                var veh = markerMap[value['registration']];
                if (veh.getVisible() == true) {
                    veh.iw = new google.maps.InfoWindow({ disableAutoPan: true });
                    //veh.iw = markerMap[value['registration']].infoWindow;
                    veh.iw.setContent(contentString);
                    google.maps.event.addListener(veh.iw, 'domready', function () {
                        $('.gm-style-iw-c').css({ 'width': 'auto', 'background-color': '#000', 'opacity': '0.8', 'height': 'auto', 'font-size': '12px', 'color': '#fff', 'padding': '5px', 'position': 'absolute', 'top': '18px', 'max-width': '70px' });
            ...
            u.forEach(locationMapMarkers, function (value) {
                var loc = value;
                loc.iwl = new google.maps.InfoWindow();
                loc.iwl.setContent(loc.locationName);
                loc.iw.disableAutoPan = false;
        ...
        hideAllStoredMarkersTag: function hideAllStoredMarkersTag() {
            var _this = this;
        ...
        plotMapPinByFilter: function plotMapPinByFilter() {
            var _this = this;
            var visibleMarkers = [];
            var bounds = new google.maps.LatLngBounds();
            _this.hideAllVehicleMarkers();
            _this.hideAllStoredMarkersTag();
            //locations
            _this.showLocations(true);
            //vehicles
            u.forEach(_this.vehicles_on_fleet, function (v) {
                //this foreach is basically to check inarray
                var vId = v.vehicle_id;
                var vRegistration = v.registration;
                var regionId = v.regionId;
                var vehicleTypeId = v.vehicleTypeId;
        ...
        plotVehiclesByVehicleIdList: function plotVehiclesByVehicleIdList(sRegList) {
            ...
            u.forEach(sRegList, function (sReg) {
                //this foreach is basically to check inarray
        ...
        clearLiveVehicleSearch: function clearLiveVehicleSearch() {
            $("#processingModal").modal("show");
            var vm = this;
        ...
        bindSelect3: function bindSelect3() {
        ...
        showLocations: function showLocations() {
            var actionFromFilter = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];

            var vm = this;
            if (actionFromFilter == true) {
                //when already location marker exist and this function called for filter.
            ...
            this.$http.post('/telematics/getAllLocations').success(function (response) {
                $("#processingModal").modal('hide');
                ...
                if (locationMarkers.length > 0) {
                    for (i = 0; i < locationMarkers.length; i++) {
                        ...
                        if (actionFromFilter == true) {
                            //when it comes from filter modal
        ...
        getLocationMarkerDetailsAjaxCall: function getLocationMarkerDetailsAjaxCall(marker, locationId) {
            _clearInfoWindow();
            $.ajax({
                ...
                success: function success(response) {
                    ...
                    //console.log('get location marker : '+JSON.stringify(marker.position));
                    ...
                    google.maps.event.addDomListener(btnViewLocationZoom, 'click', function (event) {
                        var markerZoomValue = map.getZoom();
        ...
        bindInfoWindowEventListenerForLocation: function bindInfoWindowEventListenerForLocation(marker) {
            var _this = this;
            marker.addListener('click', function (event) {
                $("#processingModal").modal('show');
                _this.hideAllStoredMarkersTag();
        ...
        displayMapOnThePage: function displayMapOnThePage() {
        ...
        getLiveTabPageVehicleDetailChart: function getLiveTabPageVehicleDetailChart(vehicleId) {
            ...
            $.ajax({
                ...
                method: 'post',
                data: { vehicleId: vehicleId, filter: filter },
                dataType: 'json',
                success: function success(response) {
                    if (response.status == 1) {
                        var d = response.data;
                        ...
                        for (var i = 0; i < rd.length; i++) {
                            ...
                            if (rd[i].incident_count != undefined && rd[i].incident_count == 0) {
                                ...
                                setObj.color = '#FD2B25';
                                setObj.toolTipContent = rd[i].incident_count.toString();
                            }
        ...
        setLiveTabPageVehicleDetailChart: function setLiveTabPageVehicleDetailChart(chartDataObj) {
...
$(document).on('change', '#searchBoxLiveMap', function () {
    ...
    var searchedLiveMap = $("#searchBoxLiveMap").val();
...
$(document).on('change', '.journeyFilterByTime', function () {
    var thisFilterTime = $(this).val();
    var thisFilterTimeText = $(this).text();
    $('.getLiveTabPageVehicleDetailChart').text(thisFilterTimeText);
    telematics.getLiveTabPageVehicleDetailChart(liveTabLastDetailOfVehicleId, thisFilterTime);
});
...
$(document).on('click', '._locationCategoryList', function () {
    var locationCategoryId = $(this).attr('locationCategoryId');
...
$(document).on('click', '._locationList', function () {
    var locationId = $(this).attr('locationIdByCategory');
...
$(document).on('click', '#liveTabRegionFilterAllCheckBox', function () {
    var thisChecked = $(this).closest('span').hasClass('checked');
    liveTabRegionFilter = [];
...
$(document).on('click', '.liveTabRegionFilterCheckBox', function () {
    ...
    var thisChecked = liveTabRegionFilter.includes(r);
    if (thisChecked == false) {
...
$(document).on('click', '.liveTabVehicleTypeFilterCheckBox', function () {
    ...
    var thisChecked = liveTabVehicleTypeFilter.includes(r);
    if (thisChecked == false) {
...
$(document).on('click', '#liveTabAllLocationCategoryFilterAllCheckBox', function () {
    ...
    if (timer) clearTimeout(timer);
    timer = setTimeout(function () {
        telematics.plotMapPinByFilter(true);
        filteredTagListGenerator();
    }, waitTime);
});
...
$(document).on('click', '.liveTabAllLocationCategoryFilterCheckBox', function () {
    ...
    var thisChecked = liveTabAllLocationCategoryFilter.includes(r);
    if (thisChecked == false) {
...
function filteredTagListGenerator() {
    ...
    if (filteredTagList.length > 0) {
        ...
        var tagRange = 5;
        var breakTagRange = 4;
        var otherTagCount = parseInt(filteredTagList.length) - parseInt(breakTagRange);
        if (otherTagCount == 1) {
            breakTagRange += 1;
        }
        if (filteredTagList.length < tagRange) {
            //when 5 is tagrange but filter have only 3 object
            tagRange = filteredTagList.length;
        }
        var loopIteration = 1;
        for (var i = 0; i < tagRange; i++) {
            var tagId = filteredTagList[i].id;
            var tagText = filteredTagList[i].text;
            var tagFilterClassName = filteredTagList[i].filterClassName;
...
$(document).on('click', '.pill-remove-btn', function () {
    var thisTagFilterClassNameValueId = $(this).attr('tagId');
    var thisTagFilterClassName = $(this).attr('tagFilterClassName');
    var tagDataKey = '';
    ...
    var findFilteredValue = $('.' + thisTagFilterClassName + '[data-' + tagDataKey + '="' + thisTagFilterClassNameValueId + '"]');
...
$(document).on('click', '.pill-other-btn', function () {
    var checkHasExapandCollapseClass = $('#filterTagFiller').next().hasClass('btnCollapsible expanded');
    if (checkHasExapandCollapseClass == false) {
        $('#filterTagFiller').next('.btnCollapsible').trigger('click');
    }
});
...
$(document).on('click', '#btnLocationMarkerShow', function () {
    if ($(this).hasClass('red-rubine') == 1) {
        $(this).addClass('button-outline-class');
        $(this).removeClass('red-rubine');
        telematics.removeLocationMapMarkers();
    } else {
        $(this).addClass('red-rubine');
        $(this).removeClass('button-outline-class');
...
},{"lodash":13,"socket.io-client":16,"vue":56,"vue-resource":49}]},{},[58]);
